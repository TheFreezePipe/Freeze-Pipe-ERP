-- =============================================================
-- Daily report: Marketing "next 14 days" section (Phase A)
-- =============================================================
-- Adds a 'marketing' key to rpc_daily_report: sales overlapping the next
-- 14 days (with resolved SKU counts via mkt_offer_sku_expansion), launches
-- and broadcasts in-window, and a list of proposed events awaiting ops
-- confirmation. Everything else identical to 20260703000002.
