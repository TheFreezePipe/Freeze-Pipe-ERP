-- =============================================================
-- Daily report: Early Access dates in the marketing section
-- =============================================================
-- Companion to 20260827000007_early_access.sql. Sales/launches carry an
-- 'early_access' date in the marketing JSON, and the 14-day upcoming
-- window keys on the EA date when set so an event surfaces as soon as its
-- early-access window is near, not just its public date. The email
-- template renders "EA <date>" ahead of the public dates.
